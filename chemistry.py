...
def main():
    ...
    while response.lower() != 'quit':
        ...
        print("Separating chemical formula.")
        sleep(5)
        parse_formula(chemical_formula, periodic_table)
        print("Chemical formula separated.")
        print()
        sleep(1)
        # # Call the compute_molar_mass function to compute the
        # # molar mass of the molecule from the compound list.
        # Compute the number of moles of the sample.
        print("Calculating molar mass:")
        sleep(5)
        molar_mass = compute_molar_mass(parse_formula(chemical_formula, periodic_table),periodic_table)
        ...
        print(f"The number of moles of the sample are: {number_of_moles:.5f} moles\n")

        response = input("Do you want to run the program again (yes/quit)? ")
    print("Goodbye.")
